-- Null Protocol runtime v9.1 entry
-- v7 = reconstructed runtime + critical diagnostics
-- v8 = deterministic menu open/close presentation
-- v9.1 = emote requests + immediate server-approved weapon delivery
...
local ok,result=xpcall(function()
    ...
    run(BASE.."0b99f126c4f46f30f96ac16ee8704b088b690fff/ui_actions_v9.lua","NullProtocolActionsV9_1")
    print("[Null Protocol] v9.1 runtime active")
    return value
end,function(e)
    local msg=tostring(e)
    warn("[Null Protocol v9.1] "..msg)
    pcall(function()
        local pg=game:GetService("Players").LocalPlayer:FindFirstChild("PlayerGui")
        local g=pg and pg:FindFirstChild("__NPBootstrap")
        local l=g and g:FindFirstChildWhichIsA("TextLabel",true)
        if l then
            l.Text="Null Protocol v9.1 ERROR: "..msg
